...
INDEX_PATH = r'research/stage9_core_arbitration_v2/evidence/stage9_index.json'
...
with open('research/stage9_core_arbitration_v2/evidence/r7_recursion_denominators.json', 'w', encoding='utf-8') as f:
