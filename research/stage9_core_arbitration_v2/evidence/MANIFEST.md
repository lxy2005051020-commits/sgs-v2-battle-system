...
| **`tests/`** | 10 项核心抽象与形式化不变量单元测试套件 | `pytest research/stage9_core_arbitration_v2/evidence/tests/` |
...
1. 运行自动化测试套件：
   ```bash
   pytest research/stage9_core_arbitration_v2/evidence/tests/ -v
   ```
...
```bash
python research/stage9_core_arbitration_v2/evidence/run_bf01_reextraction.py
python research/stage9_core_arbitration_v2/evidence/run_bf05_reextraction.py
python research/stage9_core_arbitration_v2/evidence/run_bf06_reextraction.py
python research/stage9_core_arbitration_v2/evidence/run_spot_check.py
```
