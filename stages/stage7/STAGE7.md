...
且 `stages/stage6/STAGE6_FINAL_AUDIT.md` 已完成独立最终审计，Stage 6 实现与审计均已进入 `main`，对应 main CI 成功。
...
```text
stages/stage7/STAGE7_EVIDENCE_MATRIX.md
```
...
第三轮快速设计复审
↓
stages/stage7/STAGE7_BUILD_PROMPT.md
↓
Stage 7 施工分支
↓
pytest + demo + CI
