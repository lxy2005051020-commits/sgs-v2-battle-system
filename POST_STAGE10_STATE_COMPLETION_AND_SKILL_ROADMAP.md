...
十一者均未 Runtime FROZEN；690090 / 690091 / 690102 保持 `SKELETON_ONLY`，其余既有 Research-FROZEN 状态保持当前 `NOT_INTEGRATED` 记录。
