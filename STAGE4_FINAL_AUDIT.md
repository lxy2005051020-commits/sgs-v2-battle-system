...
> 本文记录 Stage 4 的最终独立封版审计结果。它不是新的施工规范；Stage 4 的功能边界仍以 `STAGE4.md`、`STAGE3.md` 与 `research/official_state_catalog_v1/` 为准。
>
...
Stage 5 必须重新读取当时最新 `main`，先建立正式 `STAGE5.md`，不得根据本次审计时的旧 SHA 猜测仓库状态。
