...
class EventType(str, Enum):
    CHAIN_SLOT_VISITED = "CHAIN_SLOT_VISITED"
    CHAIN_FEEDBACK = "CHAIN_FEEDBACK"
    COUNTER_EXECUTE = "COUNTER_EXECUTE"
    COUNTER_ZERO_LOSS = "COUNTER_ZERO_LOSS"
    ...
    DIRECT_TROOP_LOSS = "DIRECT_TROOP_LOSS"
    ...
    COMBO_OPPORTUNITY_CONSUMED = "COMBO_OPPORTUNITY_CONSUMED"
    STATE_CLEARED_ON_BATTLE_END = "STATE_CLEARED_ON_BATTLE_END"
